...
import { FileBadge, Plus, Search, Download } from "lucide-react";
import { useMemo, useState } from "react";
import { fmtMoney } from "@/lib/mock-data";

export const Route = createFileRoute("/manager/offers")({
  component: ManagerOffersPage,
  head: () => ({ meta: [{ title: "Quotations & Offers · Manager" }] }),
});
...
function ManagerOffersPage() {
  ...
  return (
    <AppShell panel="manager" user={{ name: "hafez Rahim", role: t("manager"), initials: "HR" }} pageTitle={t("offers")}>
