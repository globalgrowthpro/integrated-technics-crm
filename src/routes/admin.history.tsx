...
const MODULES: { key: HistoryModule | "all"; label: string; icon: any; tone: string; i18nKey: any }[] = [
  ...
  { key: "project", label: "Projects", icon: Briefcase, tone: "text-violet-600", i18nKey: "projects" },
...
function HistoryPage() {
  ...
  return (
    <AppShell panel="admin" user={{ name: "hafez Rahim", role: t("admin"), initials: "HR" }} pageTitle={t("history")}>
